...
0x8,    0x1,    0x2,    0x0,    0x0,    0x0,    0x0, //TPA TPB SRAB TPC TPD SRCD RP
0x1,    0x1,    0x0,    0x2,    0x2,    0x0,    0x0,
...
void EPD_SendDisplay(uint8_t *image)
{
	...
	SPI_MasterDMATrans(image+4000,736);
	CS_HIGH;
