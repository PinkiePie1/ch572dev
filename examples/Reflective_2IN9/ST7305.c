...
void ST7305_Init(void)
{
    ...
    dCMD(0xD1);dDAT(0x01);
    dCMD(0xC0);dDAT(0x12);dDAT(0x0A);
    dCMD(0xC1);dDAT(155);dDAT(0x3E);dDAT(0x3C);dDAT(0x3C);
    dCMD(0xC2);dDAT(0x00);dDAT(0x21);dDAT(0x23);dDAT(0x23);
    dCMD(0xC4);dDAT(50);dDAT(0x5C);dDAT(0x5A);dDAT(0x5A);
    dCMD(0xC5);dDAT(50);dDAT(0x35);dDAT(0x37);dDAT(0x37);
